...
namespace Lab13.Controllers
{
    public class PersonaController : Controller
    {
        ...
        public ActionResult Listar(string buscarpor, string buscar)
        {
            ...
            if (buscarpor == "Nombre")
            {
                return View(personas.Where(x => x.Nombre.StartsWith(buscar) || buscar == null).ToList());
            }
            else if (buscarpor == "Apellido")
            {
                return View(personas.Where(x => x.Apellido.StartsWith(buscar) || buscar == null).ToList());
            }
            else
            {
